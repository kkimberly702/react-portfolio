...
<a href="https://twitter.com/dev_kimbeverly" target="_blank"><img className="profile-img" src={imgkim}/></a>
      ...
      <br></br>
        ...
        <a href="https://earth.google.com/web/@36.40294029,-115.32574965,969.16324215a,364389.25463475d,35y,-134.12416448h,58.09596309t,0r/data=Cg8aDQoHL20vMHlqcRgBIAE?utm_source=referral&utm_campaign=marketingutm_campaign=earthview%3Futm_source%3Dwebtekno" target="_blank"><LocationOnIcon /> <b>Las Vegas, Nevada</b></a>
...
<div className="project-box">
        <b className='name'>Kimberly</b> <span className='twitter-handle'>@dev_kimbeverly </span>
        <p>
        <a href="https://kkimberly702.github.io/project-btc-rsi/" target="_blank"><b>Easy Trade Signals using Indicators</b></a>
        <br></br>
        This was a project I created using React with a focus on API's. I used the Bitcoin 1 hour Relative Strength Index API. I included a possible entry/exit signal for a trade. 
        </p>
      ...
      <div className="project-box">
        ...
        <br></br>
        This project was created by myself and two other software developers. The idea of JobTrackr was to help keep track of jobs posted. It was developed using Mongoose, Express, React and Node.js.
        </p>
        ...
        <CommentsDisabledIcon fontSize='small'/>
        <RepeatIcon fontSize='small'/>
        <span id='heart-icon'><FavoriteIcon fontSize='small' /></span>
      ...
      <div className="project-box">
        ...
        <br></br>
        This was my first attempt at making my personal portfolio. It was developed using HTML, CSS and JavaScript.
        </p>
